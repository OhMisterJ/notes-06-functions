/* A function is declared using the 'function' keyword, followed by the function's name, then its parameters/arguments in round braces. And finally, in curly braces, you write out the instructions or code that the function should perform. For example... */
...
myLocalShirts(); // Call myLocalShirts() function and run it
var shirts = 'Sweater';
document.getElementById('scope2').innerHTML = shirts;
myLocalShirts();

/* Create a function that will take in two arguments then return a value. */
...
document.getElementById('modulus').innerHTML = 'The mod of modNumbers is ' + modNumbers(9, 5);
